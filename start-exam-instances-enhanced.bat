...
echo Step 1: Cleaning and compiling Exam service...
...
start "Exam Service 1" cmd /k "cd /d %CURRENT_DIR%\Exam && mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=8040 --spring.jpa.hibernate.ddl-auto=create-drop"
...
start "Exam Service 2" cmd /k "cd /d %CURRENT_DIR%\Exam && mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=8041 --spring.jpa.hibernate.ddl-auto=create-drop"
...
start "Exam Service 3" cmd /k "cd /d %CURRENT_DIR%\Exam && mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=8042 --spring.jpa.hibernate.ddl-auto=create-drop"
